...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Add sentence about surrounding cells

        surround_cells = set()

        for i in range(cell[0] - 1, cell[0] + 2): # Iterating over surrounding cells
            for j in range(cell[1] - 1, cell[1] + 2):
                if (i, j) == cell:
                    continue
        ...
        for cell in surround_cells:
            if not (cell in self.moves_made or cell in self.safes): # Filter out cells we know are move_made, or already safe
                new_cells.add(cell)
            ...
            if len(s1.cells) == 0:
                ...
                for s2 in self.knowledge:
                    if len(s2.cells) == 0:
                        ...
                        to_add.append(Sentence(s2.cells - s1.cells, s2.count - s1.count))
